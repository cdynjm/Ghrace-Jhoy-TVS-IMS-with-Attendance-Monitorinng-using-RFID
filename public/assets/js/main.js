...
document.getElementById("layout-menu") && (isHorizontalLayout = document.getElementById("layout-menu").classList.contains("menu-horizontal")),
    ...
    "undefined" != typeof $ &&
        $(function () {
            ...
            a.length &&
                a.on("click", function () {
                    n.length && (n.toggleClass("d-none"), s.focus());
                }),
                $(document).on("keydown", function (e) {
                    var t = e.ctrlKey,
                        e = 191 === e.which;
                    t && e && n.length && (n.toggleClass("d-none"), s.focus());
                }),
                setTimeout(function () {
                ...
                s.length &&
                    ...
                    $("#layout-menu").hasClass("menu-horizontal") && (a = "search-horizontal.json"),
                    (o = $.ajax({ url: assetsPath + "json/" + a, dataType: "json", async: !1 }).responseJSON),
                    s.each(function () {
                        var e = $(this);
                        s
                            .typeahead(
                                ...
                                },
                                {
                                    ...
                                    templates: {
                                        ...
                                        suggestion: function ({ src: e, name: t, subtitle: o, meta: a }) {
                                            return (
                            ...
                            .bind("typeahead:close", function () {
                                s.val(""), e.typeahead("val", ""), n.addClass("d-none"), l.addClass("fade").removeClass("show");
                            }),
                            s.on("keyup", function () {
