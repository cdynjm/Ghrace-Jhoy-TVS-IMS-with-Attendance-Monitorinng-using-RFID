                    ...
                    if (null != n) {
                        ...
                        try {
                            if (((r = (n = n.call(e)).next), 0 === t)) {
                                ...
                                u = !1;
                            } else for (; !(u = (i = r.call(n)).done) && (a.push(i.value), a.length !== t); u = !0);
                        } catch (e) {
                            (l = !0), (o = e);
                        } finally {
                            try {
                        ...
                        !0 === e
                            ? (function e() {
                                  var n,
                                      ...
                                      u,
                                      l = +new Date() - a,
                                      c = ((n = l), (i = r), (u = s), (n /= t / 2) < 1 ? (u / 2) * n * n + i : (-u / 2) * ((n -= 1) * (n - 2) - 1) + i);
                                  (o.scrollTop = c), l < t ? requestAnimationFrame(e) : (o.scrollTop = s);
                              })()
                            : (o.scrollTop = s);
                    }
                }
            ...
            scrollPageTo: function (e) {
                ...
                !(function s() {
                    var a,
                        ...
                        l,
                        c = +new Date() - r,
                        d = ((a = c), (u = i), (l = o), (a /= t / 2) < 1 ? (l / 2) * a * a + u : (-l / 2) * ((a -= 1) * (a - 2) - 1) + u);
            ...
            setContentLayout: function () {
                ...
                setTimeout(function () {
                    var n,
                        ...
                        o = document.querySelector(".layout-navbar > div"),
                        r = document.querySelector(".layout-navbar .search-input-wrapper"),
                        s = document.querySelector(".layout-navbar .search-input-wrapper .search-input"),
                        a = document.querySelector(".content-footer > div"),
                        u = [].slice.call(document.querySelectorAll(".container-fluid")),
                        l = [].slice.call(document.querySelectorAll(".container-xxl")),
                        c = !1;
                    document.querySelector(".content-wrapper > .menu-horizontal > div") && ((c = !0), (n = document.querySelector(".content-wrapper > .menu-horizontal > div"))),
                        "compact" === t
                            ? (u.some(function (e) {
                                  return [i, o, a].includes(e);
                              }) && (e._removeClass("container-fluid", [i, o, a]), e._addClass("container-xxl", [i, o, a])),
                              r && s && (e._removeClass("container-fluid", [r, s]), e._addClass("container-xxl", [r, s])),
                              c && (e._removeClass("container-fluid", n), e._addClass("container-xxl", n)))
                            : (l.some(function (e) {
                                  return [i, o, a].includes(e);
                              }) && (e._removeClass("container-xxl", [i, o, a]), e._addClass("container-fluid", [i, o, a])),
                              r && s && (e._removeClass("container-xxl", [r, s]), e._addClass("container-fluid", [r, s])),
                              c && (e._removeClass("container-xxl", n), e._addClass("container-fluid", n)));
                }, 100);
            },
            update: function () {
