                                  ...
                                  <div class="col-md-12">
                                      ...
                                      <div class="row mb-4">
                                        ...
                                        <div class="col-md-4 mb-4">
                                          ...
                                          <label for="" style="font-size: 11px">Region <span class="text-danger" style="font-size: 16px">*</span></label>
                                          @include('auth.address.region')
        
                                          <label for="" style="font-size: 11px">Province <span class="text-danger" style="font-size: 16px">*</span></label>
                                          @include('auth.address.province')
        
                                          <label for="" style="font-size: 11px">Municipal <span class="text-danger" style="font-size: 16px">*</span></label>
                                          @include('auth.address.municipal')
        
                                          <label for="" style="font-size: 11px">Barangay <span class="text-danger" style="font-size: 16px">*</span></label>
                                        ...
                                        <div class="col-md-4">
                                          ...
                                          <label for="" style="font-size: 11px">Contact Number <span class="text-danger" style="font-size: 16px">*</span></label>
                                          <input type="number" name="phone" class="form-control" required>
        
                                          <label for="" style="font-size: 11px">Nationality <span class="text-danger" style="font-size: 16px">*</span></label>
                                      ...
                                      <div class="text-danger mb-2" style="font-size: 13px">* Required</div>
                                        ...
                                        <div class="row mb-4">
                                          <div class="col-md-6 mb-4">
                                            <div><b>3.1 Sex</b> <span class="text-danger" style="font-size: 16px">*</span></div>
                                            <div>
                                          ...
                                          <div class="col-md-6 mb-4">
                                            <div><b>3.2 Civil Status</b> <span class="text-danger" style="font-size: 16px">*</span></div>
                                            <div>
                                          ...
                                          <div class="col-md-6 mb-4">
                                            <div><b>3.3 Employment (before the training)</b> <span class="text-danger" style="font-size: 16px">*</span></div>
                                            <div class="row">
                                              <div class="col-md-6 mb-4">
                                          ...
                                          <div class="col-md-6 mb-4">
                                            ...
                                            <div class="row mb-2">
                                              <div class="col-md-6">
                                                <label for="" style="font-size: 11px">Date <span class="text-danger" style="font-size: 16px">*</span></label>
                                            ...
                                            <div class="row">
                                              ...
                                              <div class="col-md-6">
                                                <label for="" style="font-size: 11px">City/Municipality <span class="text-danger" style="font-size: 16px">*</span></label>
                                                @include('auth.birthplace.municipal')
                                              </div>
                                            </div>
                                          </div>
                                          <div class="col-md-8 mb-4">
                                            <div><b>3.6 Educational Attainment Before the Training (Trainee)</b> <span class="text-danger" style="font-size: 16px">*</span></div>
                                              @php
                                                $educ = [];
                                          ...
                                          <div class="col-md-4 mb-4">
                                            ...
                                            <label for="" style="font-size: 11px">Name <span class="text-danger" style="font-size: 16px">*</span></label>
                                            <input type="text" name="parent" class="form-control" required>

                                            <label for="" style="font-size: 11px">Parent's Contact Number <span class="text-danger" style="font-size: 16px">*</span></label>
                                            <input type="text" name="parentContact" class="form-control" required>

                                            <label for="" style="font-size: 11px">Complete Permanent Mailing Address <span class="text-danger" style="font-size: 16px">*</span></label>
                                  ...
                                  <div class="col-md-12">
                                    ...
                                    <div class="row mb-4">
                                      <div class="col-md-12 mb-4">
                                        <label for="" style="font-size: 11px">Course <span class="text-danger" style="font-size: 16px">*</span></label>
                                    ...
                                    <div class="row mb-4">
                                      <div class="col-md-12">
                                          ...
                                          <div>
                                            ...
                                            <label for="">Agree <span class="text-danger" style="font-size: 16px">*</span></label>
                                          </div>
                              ...
                              <div id="account-credentials-vertical" class="content">
                                ...
                                <div class="row">
                                  <div class="col-md-12">
                                    ...
                                    <div class="text-danger mb-2" style="font-size: 13px">* Required</div>
                                    <div class="mb-2">
                                      <small class="fw-bold">This account will be your permanent access to all your information within the system. Please ensure you remember your credentials and keep them secure.</small>
                                    </div>
