                    ...
                    <div class="card">
                        <div class="card-header">
                            <a class="nav-link hide-arrow d-flex" href="javascript:void(0);" data-bs-toggle="dropdown">
                                ...
                                <span class="me-3 mt-2 fw-medium"> {{ Auth::user()->Student->lastname }} {{ Auth::user()->Student->firstname }} {{ Auth::user()->Student->middlename }}</span>
                            </a>
                        </div>
                    </div>
                </div>
                @include('data.student.attendance-data')
