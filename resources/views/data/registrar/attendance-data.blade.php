        ...
        @foreach ($courses as $cor)
            ...
            <tr>
                ...
                <td class="text-center">
                    <div class="d-flex">
                        <a class="btn btn-sm btn-primary flex-fill me-1" wire:navigate href="{{ route('registrar.view-attendance', ['id' => $aes->encrypt($cor->id)]) }}">
                            <iconify-icon icon="streamline:voice-scan-2-solid" width="18" height="18" class="me-1"></iconify-icon> View
                        </a>
                    </div>                    
                </td>
            </tr>
